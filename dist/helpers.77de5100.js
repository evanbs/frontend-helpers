...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"ts/Postcode.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Object.defineProperty(Postcode.prototype, "postcodeInput", {
    get: function get() {
      var element = document.querySelector('input[postcode]');
  ...
  Postcode.prototype.setStreetInput = function (street) {
    var element = document.querySelector('input[postcode-street]');
  ...
  Postcode.prototype.setComplementInput = function (complement) {
    var element = document.querySelector('input[postcode-complement]');
  ...
  Postcode.prototype.setDistrictInput = function (district) {
    var element = document.querySelector('input[postcode-district]');
  ...
  Postcode.prototype.setCityInput = function (city) {
    var element = document.querySelector('input[postcode-city]');
  ...
  Postcode.prototype.setStateInput = function (state) {
    var element = document.querySelector('input[postcode-state]');
  ...
  Postcode.prototype.setListener = function () {
    var _this = this;

    this.postcodeInput.addEventListener('blur', function () {
      return _this.setFields();
    });
  };

  Postcode.prototype.setFields = function () {
  ...
  Postcode.prototype.clearFields = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        this.setStreetInput('');
  ...
  Postcode.prototype.getPostcodeData = function () {
    return __awaiter(this, void 0, Promise, function () {
      var postcode, response, postcodeData;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , axios_1.default.get("https://viacep.com.br/ws/" + postcode + "/json/")];
  ...
  Postcode.prototype.isResponseValid = function (response) {
    var isValid = false;
...
},{"axios":"node_modules/axios/index.js"}],"ts/IsMobileBrowser.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Object.defineProperty(isMobileBrowser.prototype, "userAgent", {
    get: function get() {
  ...
  isMobileBrowser.prototype.init = function () {
...
var Postcode_1 = __importDefault(require("./ts/Postcode"));

var IsMobileBrowser_1 = __importDefault(require("./ts/IsMobileBrowser"));

var postcode = new Postcode_1.default();
postcode.init();
var isMobileBrowser = new IsMobileBrowser_1.default();
isMobileBrowser.init();
},{"./ts/Postcode":"ts/Postcode.ts","./ts/IsMobileBrowser":"ts/IsMobileBrowser.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/helpers.77de5100.js.map